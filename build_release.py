...
wrap_dir = "blender_apply_all_modifiers"  # Wrap the output in a directory in the ZIP file
output_file = f"blender_apply_all_modifiers_{tag_name}.zip"  # What to call the ZIP file
